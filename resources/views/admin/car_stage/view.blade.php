                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-header" style="display: flex; justify-content: space-between;">
                                    ...
                                    <a href="{{ route('car_stage.create') }} " class="btn btn-primary"> Add Car
                                        Stage</a>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="display" id="basic-1">
                                            ...
                                            <tbody>
                                                @foreach ($car_stage_view as $data)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <ul class="action">
                                                                <li class="edit"> <a
                                                                        href="{{ route('car_stage.edit', encrypt($data->car_stage_id)) }}"><i
                                                                            class="icon-pencil-alt"></i></a></li>
                                                                <li class="delete"><a
                                                                        href="{{ route('car_stage.delete', encrypt($data->car_stage_id)) }}"><i
